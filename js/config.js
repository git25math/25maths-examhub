...
var RANKS = [
  ...
  { min: 15, emoji: '\ud83e\udd48', name: '\u767d\u94f6\u63a2\u7d22\u8005', nameEn: 'Silver Explorer', color: '#C0C0C0' },
  { min: 40, emoji: '\ud83e\udd47', name: '\u9ec4\u91d1\u5b66\u8005', nameEn: 'Gold Scholar', color: '#FFD700' },
  { min: 65, emoji: '\ud83d\udc8e', name: '\u94bb\u77f3\u5927\u5e08', nameEn: 'Diamond Master', color: '#B9F2FF' },
  { min: 90, emoji: '\ud83d\udc51', name: '\u6570\u5b66\u738b\u8005', nameEn: 'Math Champion', color: '#FF6B6B' }
];
...
function isLevelVisible(lv) {
  ...
  /* Y11 sees CIE + all 25m; other 25m-yN sees all 25m */
  if (userBoard === '25m-y11') return lv.board === 'cie' || lv.board === '25m';
  if (userBoard.indexOf('25m-') === 0) return lv.board === '25m';
}
