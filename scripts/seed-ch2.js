...
add('edexcel', '2.1', 'examples', {
  ...
  content_zh:
    ...
    '<b>解答：</b>$P = 2(8.5 + 3.2) = 23.4$<br><br>' +
    '<b>考试技巧：</b>必须写出代入步骤，不要直接跳到答案。'
});
...
add('edexcel', '2.3', 'examples', {
  ...
  content_zh:
    ...
    '$x = \\frac{y+2}{y-3}$<br><br>' +
    '<b>考试技巧：</b>将含 $x$ 的项移到一边，其余移到另一边，然后提取 $x$ 的公因式。'
});
...
add('edexcel', '2.4', 'examples', {
  ...
  content_zh:
    ...
    '$11x = 17$，$x = \\frac{17}{11}$<br><br>' +
    '<b>考试技巧：</b>交叉相乘或找分母的最小公倍数。'
});
...
add('edexcel', '2.5', 'examples', {
  ...
  content_zh:
    ...
    '$x = 25$：$y = 2.5 \\times 5 = 12.5$<br><br>' +
    '<b>考试技巧：</b>先求出常数 $k$，写出完整公式后再代入新值。'
});
...
add('edexcel', '2.7', 'examples', {
  ...
  content_zh:
    ...
    '$x = 0.87$ 或 $x = -1.54$<br><br>' +
    '<b>考试技巧：</b>使用求根公式时，先算判别式，再分别算两个 $x$ 的值。'
});
