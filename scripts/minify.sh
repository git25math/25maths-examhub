...
cat js/config.js js/levels-loader.js js/storage.js js/particles.js \
    ...
    js/stats.js js/practice.js js/learning-graph.js js/worksheet.js js/recovery-priority.js js/recovery-scheduler.js js/student-profile.js js/recovery-session.js js/app.js | \
