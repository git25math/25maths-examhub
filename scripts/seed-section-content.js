...
add('edexcel', '1.1', 'examples', {
  ...
  content_zh:
    ...
    'LCM = $2^2 \\times 3^2 \\times 5 = 180$<br><br>' +
    '<b>考试技巧：</b>先将两个数写成质因数乘积形式。使用因数树或连续除法。'
});
...
add('edexcel', '1.2', 'examples', {
  ...
  content_zh:
    ...
    '<b>解答：</b><br>' +
    '$\\frac{7}{2} \\div \\frac{7}{3} = \\frac{7}{2} \\times \\frac{3}{7} = \\frac{3}{2} = 1\\frac{1}{2}$<br><br>' +
    '<b>考试技巧：</b>将带分数转换为假分数。除法时，将第二个分数倒过来再乘。结果要化简。'
});
...
add('edexcel', '1.3', 'examples', {
  ...
  content_zh:
    ...
    '设 $x = 0.272727...$<br>' +
    '$100x = 27.2727...$<br>' +
    '$99x = 27$，$x = \\frac{27}{99} = \\frac{3}{11}$<br><br>' +
    '<b>考试技巧：</b>乘以 $10^n$（$n$ 为循环位数），然后相减消去循环部分。'
});
...
add('edexcel', '1.5', 'examples', {
  ...
  content_zh:
    ...
    '$A = \\{3,6,9,12,15,18\\}$，$B = \\{4,8,12,16,20\\}$<br>' +
    '(a) $A \\cap B = \\{12\\}$<br>' +
    '(b) $n(A \\cup B) = 6 + 5 - 1 = 10$<br><br>' +
    '<b>考试技巧：</b>$A \\cap B$ 表示同时是 3 和 4 的倍数 = LCM(3,4) = 12 的倍数。'
});
